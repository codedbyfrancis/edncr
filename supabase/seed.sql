...
VALUES
    ...
    (
        ...
        '/images/blog/career-roadmap.jpg',
        '00000000-0000-0000-0000-000000000002',
        NULL,
        'for_modification',
        now() - interval '3 days',
    ...
    (
        ...
        '/images/blog/database-patterns.jpg',
        '00000000-0000-0000-0000-000000000003',
        '00000000-0000-0000-0000-000000000005',
        'approved',
        now() - interval '12 days',
    ...
    (
        ...
        '/images/blog/remote-leadership.jpg',
        '00000000-0000-0000-0000-000000000004',
        NULL,
        'for_review',
        now() - interval '4 days',
    ...
    (
        ...
        '/images/blog/kubernetes-guide.jpg',
        '00000000-0000-0000-0000-000000000003',
        '00000000-0000-0000-0000-000000000004',
        'approved',
        now() - interval '18 days',
    ...
    (
        ...
        '/images/blog/developer-health.jpg',
        '00000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000003',
        'approved',
        now() - interval '30 days',
    ...
    (
        ...
        '/images/blog/freelance-guide.jpg',
        '00000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000004',
        'approved',
    ...
    (
        ...
        '/images/blog/performance-optimization.jpg',
        '00000000-0000-0000-0000-000000000003',
        '00000000-0000-0000-0000-000000000005',
        'approved',
        now() - interval '14 days',
    ...
    (
        ...
        '/images/blog/continuous-learning.jpg',
        '00000000-0000-0000-0000-000000000002',
        NULL,
        'for_review',
        now() - interval '1 day',
    ...
    (
        ...
        '/images/blog/state-management.jpg',
        '00000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000003',
        'approved',
        now() - interval '8 days',
    ...
    (
        ...
        '/images/blog/work-life-balance.jpg',
        '00000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000005',
        'approved',
    ...
    (
        ...
        '/images/blog/blockchain-dev.jpg',
        '00000000-0000-0000-0000-000000000003',
        NULL,
        'editing',
    ...
    (
        ...
        '/images/blog/open-source-monetization.jpg',
        '00000000-0000-0000-0000-000000000004',
        '00000000-0000-0000-0000-000000000005',
        'approved',
        now() - interval '28 days',
    ...
    (
        ...
        '/images/blog/developer-networking.jpg',
        '00000000-0000-0000-0000-000000000002',
        NULL,
        'for_review',
        now() - interval '7 days',
